...
class QuantitativeValue(StructuredValue):
    ...
    valueReference: Union[List[Union[str, Enumeration, QualitativeValue, PropertyValue, MeasurementTypeEnumeration, DefinedTerm, StructuredValue, Any]], Union[str, Enumeration, QualitativeValue, PropertyValue, MeasurementTypeEnumeration, DefinedTerm, StructuredValue, Any]] = Field(
        None,
