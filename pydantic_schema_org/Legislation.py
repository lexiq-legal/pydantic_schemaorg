...
class Legislation(CreativeWork):
    ...
    legislationPassedBy: Optional[Union[List[Union[Person, Organization]], Union[Person, Organization]]] = Field(
        None,
    ...
    legislationResponsible: Optional[Union[List[Union[Person, Organization]], Union[Person, Organization]]] = Field(
        None,
