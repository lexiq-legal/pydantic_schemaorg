...
from pydantic_schema_org.MedicalContraindication import MedicalContraindication
from pydantic_schema_org.TherapeuticProcedure import TherapeuticProcedure
