...
class Event(Thing):
    ...
    attendees: Optional[Union[List[Union[Person, Organization]], Union[Person, Organization]]] = Field(
        None,
        description="A person attending the event.",
    )
    composer: Optional[Union[List[Union[Person, Organization]], Union[Person, Organization]]] = Field(
        None,
    ...
    translator: Optional[Union[List[Union[Person, Organization]], Union[Person, Organization]]] = Field(
        None,
    ...
    attendee: Optional[Union[List[Union[Person, Organization]], Union[Person, Organization]]] = Field(
        None,
    ...
    organizer: Optional[Union[List[Union[Person, Organization]], Union[Person, Organization]]] = Field(
        None,
    ...
    performers: Optional[Union[List[Union[Person, Organization]], Union[Person, Organization]]] = Field(
        None,
    ...
    performer: Optional[Union[List[Union[Person, Organization]], Union[Person, Organization]]] = Field(
        None,
    ...
    contributor: Optional[Union[List[Union[Person, Organization]], Union[Person, Organization]]] = Field(
        None,
