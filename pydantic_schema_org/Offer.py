...
from pydantic_schema_org.BusinessEntityType import BusinessEntityType
...
from pydantic_schema_org.MerchantReturnPolicy import MerchantReturnPolicy
...
class Offer(Intangible):
    ...
    availabilityStarts: Optional[Union[List[Union[datetime, date, time]], Union[datetime, date, time]]] = Field(
        None,
    ...
    offeredBy: Optional[Union[List[Union[Person, Organization]], Union[Person, Organization]]] = Field(
        None,
    ...
    itemOffered: Union[List[Union[Event, CreativeWork, Service, Product, Any]], Union[Event, CreativeWork, Service, Product, Any]] = Field(
        None,
    ...
    availabilityEnds: Optional[Union[List[Union[datetime, date, time]], Union[datetime, date, time]]] = Field(
        None,
