...
from pydantic_schema_org.GeoCoordinates import GeoCoordinates
from typing import Any, Optional, Union, List
from pydantic_schema_org.Distance import Distance
from decimal import Decimal
from pydantic_schema_org.GeoShape import GeoShape
