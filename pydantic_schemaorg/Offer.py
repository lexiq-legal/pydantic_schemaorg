...
class Offer(Intangible):
    ...
    priceValidUntil: Optional[Union[List[Union[date, str]], Union[date, str]]] = Field(
        None,
    ...
    offeredBy: Optional[Union[List[Union[Organization, Person, str]], Union[Organization, Person, str]]] = Field(
        None,
    ...
    itemOffered: Optional[Union[List[Union[Product, MenuItem, Event, CreativeWork, AggregateOffer, Service, Trip, str]], Union[Product, MenuItem, Event, CreativeWork, AggregateOffer, Service, Trip, str]]] = Field(
        None,
