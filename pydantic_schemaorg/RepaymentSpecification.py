...
class RepaymentSpecification(StructuredValue):
    ...
    Model depth: 4
    """
    type_: str = Field(default="RepaymentSpecification", alias='@type', constant=True)
    ...
    numberOfLoanPayments: Optional[Union[List[Union[int, float, 'Number', str]], int, float, 'Number', str]] = Field(
        default=None,
    ...
    loanPaymentFrequency: Optional[Union[List[Union[int, float, 'Number', str]], int, float, 'Number', str]] = Field(
        default=None,
    ...
    downPayment: Optional[Union[List[Union[int, float, 'Number', 'MonetaryAmount', str]], int, float, 'Number', 'MonetaryAmount', str]] = Field(
        default=None,
