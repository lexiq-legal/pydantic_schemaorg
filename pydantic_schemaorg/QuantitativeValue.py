...
class QuantitativeValue(StructuredValue):
    ...
    valueReference: Union[List[Union[str, QualitativeValue, Enumeration, PropertyValue, DefinedTerm, StructuredValue, MeasurementTypeEnumeration, Any]], Union[str, QualitativeValue, Enumeration, PropertyValue, DefinedTerm, StructuredValue, MeasurementTypeEnumeration, Any]] = Field(
        None,
