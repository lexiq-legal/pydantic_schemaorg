...
class Order(Intangible):
    ...
    paymentDue: "Optional[Union[List[Union[datetime, str]], Union[datetime, str]]]" = (
        Field(
            None,
    ...
    customer: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
    ...
    partOfInvoice: "Optional[Union[List[Union[Invoice, str]], Union[Invoice, str]]]" = (
        Field(
            None,
    ...
    merchant: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
