...
class Schedule(Intangible):
    ...
    exceptDate: "Optional[Union[List[Union[datetime, date, str]], Union[datetime, date, str]]]" = Field(
        None,
    ...
    byMonthDay: "Optional[Union[List[Union[int, str]], Union[int, str]]]" = Field(
        None,
    ...
    repeatCount: "Optional[Union[List[Union[int, str]], Union[int, str]]]" = Field(
        None,
    ...
    byMonthWeek: "Optional[Union[List[Union[int, str]], Union[int, str]]]" = Field(
        None,
    ...
    byMonth: "Optional[Union[List[Union[int, str]], Union[int, str]]]" = Field(
        None,
