...
class MedicalConditionStage(MedicalIntangible):
    ...
    Model depth: 4
    """
    type_: str = Field(default="MedicalConditionStage", alias='@type', constant=True)
    stageAsNumber: Optional[Union[List[Union[int, float, 'Number', str]], int, float, 'Number', str]] = Field(
        default=None,
