...
class EnergyConsumptionDetails(Intangible):
    ...
    energyEfficiencyScaleMax: "Optional[Union[List[Union[EUEnergyEfficiencyEnumeration, str]], Union[EUEnergyEfficiencyEnumeration, str]]]" = Field(
        None,
    ...
    energyEfficiencyScaleMin: "Optional[Union[List[Union[EUEnergyEfficiencyEnumeration, str]], Union[EUEnergyEfficiencyEnumeration, str]]]" = Field(
        None,
        description="Specifies the least energy efficient class on the regulated EU energy consumption scale"
        "for the product category a product belongs to. For example, energy consumption for televisions"
        "placed on the market after January 1, 2020 is scaled from D to A+++.",
    )
    hasEnergyEfficiencyCategory: "Optional[Union[List[Union[EnergyEfficiencyEnumeration, str]], Union[EnergyEfficiencyEnumeration, str]]]" = Field(
        None,
