...
class Action(Thing):
    ...
    participant: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
    ...
    agent: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
        description="The direct performer or driver of the action (animate or inanimate). e.g. *John* wrote"
        "a book.",
    )
    target: "Optional[Union[List[Union[EntryPoint, str]], Union[EntryPoint, str]]]" = (
        Field(
            None,
