...
class ShippingRateSettings(StructuredValue):
    ...
    freeShippingThreshold: "Optional[Union[List[Union[MonetaryAmount, DeliveryChargeSpecification, str]], Union[MonetaryAmount, DeliveryChargeSpecification, str]]]" = Field(
        None,
