...
class Service(Intangible):
    ...
    serviceOutput: "Optional[Union[List[Union[Thing, str]], Union[Thing, str]]]" = Field(
        None,
    ...
    termsOfService: "Optional[Union[List[Union[AnyUrl, str]], Union[AnyUrl, str]]]" = (
        Field(
            None,
            description="Human-readable terms of service documentation.",
        )
    )
    produces: "Optional[Union[List[Union[Thing, str]], Union[Thing, str]]]" = Field(
        None,
        description="The tangible thing generated by the service, e.g. a passport, permit, etc.",
    )
    ...
    availableChannel: "Optional[Union[List[Union[ServiceChannel, str]], Union[ServiceChannel, str]]]" = Field(
        None,
    ...
    serviceAudience: "Optional[Union[List[Union[Audience, str]], Union[Audience, str]]]" = Field(
        None,
