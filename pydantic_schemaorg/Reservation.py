...
class Reservation(Intangible):
    ...
    underName: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
    ...
    bookingAgent: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
    ...
    bookingTime: "Optional[Union[List[Union[datetime, str]], Union[datetime, str]]]" = (
        Field(
            None,
            description="The date and time the reservation was booked.",
        )
    )
    reservationFor: "Optional[Union[List[Union[Thing, str]], Union[Thing, str]]]" = (
        Field(
            None,
            description="The thing -- flight, event, restaurant,etc. being reserved.",
        )
    )
    broker: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
    ...
    reservedTicket: "Optional[Union[List[Union[Ticket, str]], Union[Ticket, str]]]" = (
        Field(
            None,
