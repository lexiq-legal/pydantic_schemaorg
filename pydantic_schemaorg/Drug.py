...
class Drug(Substance):
    ...
    prescribingInfo: "Optional[Union[List[Union[AnyUrl, str]], Union[AnyUrl, str]]]" = (
        Field(
            None,
    ...
    labelDetails: "Optional[Union[List[Union[AnyUrl, str]], Union[AnyUrl, str]]]" = (
        Field(
            None,
    ...
    drugClass: "Optional[Union[List[Union[DrugClass, str]], Union[DrugClass, str]]]" = (
        Field(
            None,
