...
class Place(Thing):
    ...
    geo: "Optional[Union[List[Union[GeoShape, GeoCoordinates, str]], Union[GeoShape, GeoCoordinates, str]]]" = Field(
        None,
    ...
    photos: "Optional[Union[List[Union[ImageObject, Photograph, str]], Union[ImageObject, Photograph, str]]]" = Field(
        None,
