...
class Rating(Intangible):
    ...
    Model depth: 3
    """
    type_: str = Field(default="Rating", alias='@type', constant=True)
    worstRating: Optional[Union[List[Union[int, float, 'Number', str, 'Text']], int, float, 'Number', str, 'Text']] = Field(
        default=None,
    ...
    ratingValue: Optional[Union[List[Union[int, float, 'Number', str, 'Text']], int, float, 'Number', str, 'Text']] = Field(
        default=None,
    ...
    bestRating: Optional[Union[List[Union[int, float, 'Number', str, 'Text']], int, float, 'Number', str, 'Text']] = Field(
        default=None,
