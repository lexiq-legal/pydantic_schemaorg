...
class PronounceableText(Text):
    ...
    type_: str = Field("PronounceableText", const=True, alias="@type")
    textValue: "Optional[Union[List[str], str]]" = Field(
        None,
        description="Text value being annotated.",
    )
    phoneticText: "Optional[Union[List[str], str]]" = Field(
        None,
    ...
    speechToTextMarkup: "Optional[Union[List[str], str]]" = Field(
        None,
...
if TYPE_CHECKING:
    ...
    PronounceableText.update_forward_refs()
