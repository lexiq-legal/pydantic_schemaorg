...
class Organization(Thing):
    ...
    foundingLocation: "Optional[Union[List[Union[Place, str]], Union[Place, str]]]" = (
        Field(
            None,
    ...
    dissolutionDate: "Optional[Union[List[Union[date, str]], Union[date, str]]]" = (
        Field(
            None,
    ...
    serviceArea: "Optional[Union[List[Union[GeoShape, Place, AdministrativeArea, str]], Union[GeoShape, Place, AdministrativeArea, str]]]" = Field(
        None,
    ...
    ownershipFundingInfo: "Optional[Union[List[Union[AnyUrl, str, AboutPage, CreativeWork]], Union[AnyUrl, str, AboutPage, CreativeWork]]]" = Field(
        None,
