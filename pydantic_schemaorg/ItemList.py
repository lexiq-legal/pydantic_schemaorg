...
class ItemList(Intangible):
    ...
    itemListElement: Optional[Union[List[Union[str, Thing, ListItem]], Union[str, Thing, ListItem]]] = Field(
        None,
    ...
    numberOfItems: Optional[Union[List[Union[int, str]], Union[int, str]]] = Field(
        None,
