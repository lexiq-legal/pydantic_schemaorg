...
class Event(Thing):
    ...
    subEvent: "Optional[Union[List[Union['Event', str]], Union['Event', str]]]" = Field(
        None,
    ...
    doorTime: "Optional[Union[List[Union[datetime, time, str]], Union[datetime, time, str]]]" = Field(
        None,
    ...
    attendees: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
    ...
    previousStartDate: "Optional[Union[List[Union[date, str]], Union[date, str]]]" = Field(
        None,
    ...
    location: "Optional[Union[List[Union[str, Place, VirtualLocation, PostalAddress]], Union[str, Place, VirtualLocation, PostalAddress]]]" = Field(
        None,
        description="The location of, for example, where an event is happening, where an organization is located,"
        "or where an action takes place.",
    )
    eventStatus: "Optional[Union[List[Union[EventStatusType, str]], Union[EventStatusType, str]]]" = Field(
        None,
    ...
    maximumPhysicalAttendeeCapacity: "Optional[Union[List[Union[int, str]], Union[int, str]]]" = Field(
        None,
    ...
    remainingAttendeeCapacity: "Optional[Union[List[Union[int, str]], Union[int, str]]]" = Field(
        None,
        description="The number of attendee places for an event that remain unallocated.",
    )
    attendee: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
    ...
    organizer: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
    ...
    workFeatured: "Optional[Union[List[Union[CreativeWork, str]], Union[CreativeWork, str]]]" = Field(
        None,
    ...
    eventAttendanceMode: "Optional[Union[List[Union[EventAttendanceModeEnumeration, str]], Union[EventAttendanceModeEnumeration, str]]]" = Field(
        None,
        description="The eventAttendanceMode of an event indicates whether it occurs online, offline, or"
        "a mix.",
    )
    superEvent: "Optional[Union[List[Union['Event', str]], Union['Event', str]]]" = Field(
        None,
    ...
    workPerformed: "Optional[Union[List[Union[CreativeWork, str]], Union[CreativeWork, str]]]" = Field(
        None,
        description="A work performed in some event, for example a play performed in a TheaterEvent.",
    )
    recordedIn: "Optional[Union[List[Union[CreativeWork, str]], Union[CreativeWork, str]]]" = Field(
        None,
        description="The CreativeWork that captured all or part of this Event.",
    )
    performers: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
        description="The main performer or performers of the event&#x2014;for example, a presenter, musician,"
        "or actor.",
    )
    maximumVirtualAttendeeCapacity: "Optional[Union[List[Union[int, str]], Union[int, str]]]" = Field(
        None,
        description="The maximum physical attendee capacity of an [[Event]] whose [[eventAttendanceMode]]"
    ...
    performer: "Optional[Union[List[Union[Person, Organization, str]], Union[Person, Organization, str]]]" = Field(
        None,
    ...
    subEvents: "Optional[Union[List[Union['Event', str]], Union['Event', str]]]" = Field(
        None,
    ...
    eventSchedule: "Optional[Union[List[Union[Schedule, str]], Union[Schedule, str]]]" = Field(
        None,
